...
include("../Connection/Connection.php");
    ...
    if (isset($_GET["action"])) {
        ...
        $sqlQry = "SELECT * from tbl_product p inner join tbl_category c on c.category_id=p.category_id where true ";
...
<div class="col-md-3 mb-2">
                            <div class="card-deck">
                                <div class="card border-secondary">
                                    <img src="../Assets/File/ProductDocs/<?php echo $rowS["product_image"]?>" class="card-img-top" height="250">
