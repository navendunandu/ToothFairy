...
if(isset($_POST["btnupdate"]))
		{
			...
			$confirm=$_POST["txtconfirm"];	
				...
				$selUser="SELECT * FROM tbl_pharmasist where Pharmasist_password='".$current."' and Pharmasist_id='".$_SESSION["Pharmasistid"]."'";
						...
						if($new==$confirm)
							{
									...
									$up="update  tbl_pharmasist set Pharmasist_password='$confirm' where Pharmasist_id='".$_SESSION["Pharmasistid"]."'";
									mysql_query($up);
