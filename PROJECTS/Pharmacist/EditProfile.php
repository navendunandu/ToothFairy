<?php
    ...
    include('Head.php');
		...
		if(isset($_POST["btnupdate"]))
		{
			...
			$up="update  tbl_pharmasist set pharmasist_name='$name',pharmasist_contact='$contact',pharmasist_email='$email'  where pharmasist_id='".$_SESSION["Pharmasistid"]."'";
			mysql_query($up);
			header("location:MyProfile.php"); 
		}
			
		$selUser="SELECT * FROM tbl_pharmasist n inner join tbl_place p on n.place_id=p.place_id inner join tbl_district d on d.district_id=p.district_id where n.pharmasist_id='".$_SESSION["Pharmasistid"]."'";
		$dataPharmasistid=mysql_query($selUser);
		if($rowUser=mysql_fetch_array($dataPharmasistid))
			{
