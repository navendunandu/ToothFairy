...
<html lang="en">
  <head>
    <title>ToothFairy &mdash; Colorlib Website Template</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
              ...
              <nav class="site-navigation text-right" role="navigation">
                <div class="container">
                  ...
                  <ul class="site-menu js-clone-nav d-none d-lg-block">
                    ...
                    <li><a href="Select.php">Take Appoinment</a></li>
                    <li><a href="../Assets/Templates/Main/services.html">Services</a></li>
                  </ul>
                </div>
              </nav>
            </div>
    ...
    <div class="site-block-half d-block d-lg-flex site-block-video">
      <div class="image bg-image order-2" style="background-image: url(../Assets/Templates/Main/images/hero_bg_1.jpg); ">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="site-block-testimony p-4 text-center">
              <div class="mb-3">
                <img src="../Assets/Templates/Main/images/person_2.jpg" alt="Image" class="img-fluid">
              </div>
              <div>
          ...
          <div class="col-lg-4">
            <div class="site-block-testimony p-4 text-center active">
              <div class="mb-3">
                <img src="../Assets/Templates/Main/images/person_1.jpg" alt="Image" class="img-fluid">
              </div>
              <div>
                 <p>Dolores perferendis ipsam animi fuga dolor pariatur aliquam esse. Modi maiores minus velit iste enim sunt iusto dolore</p>
          ...
          <div class="col-lg-4">
            <div class="site-block-testimony p-4 text-center">
              <div class="mb-3">
                <img src="../Assets/Templates/Main/images/person_3.jpg" alt="Image" class="img-fluid">
              </div>
              <div>
                 <p>Dolores perferendis ipsam animi fuga dolor pariatur aliquam esse. Modi maiores minus velit iste enim sunt iusto dolore</p>
                  ...
                  <li class="mb-3">
                    <a href="#" class="d-flex">
                      <figure class="image mr-4">
                        <img src="../Assets/Templates/Main/images/hero_bg_1.jpg" alt="" class="img-fluid">
                      </figure>
                      <div class="text">
